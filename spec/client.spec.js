...
describe('Maventa WDLS client tests', () => {
  beforeAll(async () => {
  ...
  it('Should return a list of error messages', async () => {
  ...
  it('Should load a test RI-Message with id TEST_MESSAGE_ID', async () => {
    const res = await this.maventaClient.RIMessageShow(process.env.TEST_MESSAGE_ID);
    expect(res).toBeTruthy();
  });

  it('Should try to show an empty message', async () => {
